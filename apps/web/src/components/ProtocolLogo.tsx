...
export const PROTOCOL_NAMES = { aave: 'Aave', venus: 'Venus', pancakeswap: 'PancakeSwap V3', uniswap: 'Uniswap v3', ophis: 'Ophis', 'bnb-chain': 'BNB Chain' } as const;
...
export function ProtocolLogo({ protocol }: { protocol: keyof typeof PROTOCOL_NAMES }) {
  return <span className="protocol-logo" data-protocol={protocol}>
    ...
    {protocol === 'uniswap' && <span aria-hidden>Uniswap</span>}
  </span>;
}
